...
to setup-patches ;sets up "grass" background
  ask patches
  [
    set pcolor green
...
to setup-snake ;prepares the snake

end



to move-up ;moves the snake upward
  ask turtles
  [
    set heading 0
  ]
...
to move-down ;moves the snake down
  ask turtles
  [
    set heading 180
  ]
...
to move-left ;moves the snake left
    ask turtles
  [
    set heading 270
  ]
...
to move-right ;moves the snake up
    ask turtles
  [
    set heading 90
  ]
...
to leave-trail ;leaves a trail behind the snake
  ask turtles
  [
    if pcolor = green
    [
